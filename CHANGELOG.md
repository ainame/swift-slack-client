...
* Added a shared app runtime with `App`, `AppRouter`, transport-neutral `Ack`, HTTP request handling, and optional Hummingbird integration.
...
* Updated examples, README, and DocC guides to use `SlackApp` for Socket Mode and HTTP app runtime setup.
